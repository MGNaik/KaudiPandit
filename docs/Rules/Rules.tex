...
\section*{The standard board}

\begin{center}
  \includesvg[width=0.4\textwidth]{figures/kauda_baji_board}
\end{center}
...
These crossed squares, and the centre, are the \textbf{safe squares}:

\begin{itemize}[leftmargin=2em]
  \item the four \textbf{starting squares}, one in the middle of each edge;
  \item the four \textbf{corners} of the board;
  \item the four squares that sit diagonally next to the centre;
  \item the \textbf{centre square} itself, where every player finishes.
\end{itemize}

Every other square is ordinary. What makes safe squares special is covered in
the rules below --- in short, no piece can ever be killed while it sits on one.

\section*{Moving through the board}
...
\begin{center}
  \includesvg[width=0.4\textwidth]{figures/kauda_baji_path}
\end{center}
